...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = simple.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "List Itsuki","footerText": `_HELLO KAK_ >.<
✋ 
...
//>>>>>>>>>>>>>>>>>>>>[ COMMAND ]<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<//
              ...
              simple.updatePresence(from, Presence.recording)
               list = []
            listmenu = [`allmenu2`,`shop`,`sewabot`,`groupmenu`,`stickermenu`,`downloadmenu`,`islammenu`,`animemenu`,`informationmenu`,`randomtextmenu`,`searchmenu`,`primbonmenu`,`stalkmenu`,`randomimagemenu`,`ownermenu`,`asupanmenu`,`gabut`,`game`,`meme`,`murid`,`djmenu`,`makermenu`,`walisongo`,]
               listmenuu = [`allmenu`,`shop`,`sewabot`,`grupmenu`,`stickermenu`,`downloadmenu`,`islammenu`,`animemenu`,`informationmenu`,`randomtextmenu`,`searchmenu`,`primbonmenu`,`stalkmenu`,`randomimagemenu`,`ownermenu`,`asupanmenu`,`gabut`,`game`,`meme`,`murid`,`djmenu`,`makermenu`,`walisongo`,]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '𝖎𝖙𝔰𝔲𝔨𝔦 メ Bo†z ×͜×',
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: `HY MOGA SEHAT`,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
...
case 'groupmenu':
simple.updatePresence(from, Presence.recording)
img =  fs.readFileSync('./poto/groupmenu.jpg')
emm = `Hai, ${pushname}
${tampilUcapan}
Name Bot : ${botname} 
Jam : ${time}
...
🐣. *MEMBATASI MOBILITAS*`
 ...
 but = [
          { buttonId: `${prefix}command`, buttonText: { displayText: 'BAKC TO MENU' }, type: 1 },
] 
...
tescok = `Hai ${pushname} 👋${tampilUcapan}
I'M ITSUKI Bo†z ×͜×
BOT INFO
✿ _*Nama Bot : ${botname}*_
✮ _️Nama Owner : ${ownername}_
...
〔 *${botname}* 〕`
Sendbutdocument(from, tescok, "© 𝖎𝖙𝔰𝔲𝔨𝔦 メ Bo†z✭", fs.readFileSync('./poto/menu.pdf'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./poto/image/thumbnaildokumen.jpg'), filename:`Herman Chanel.pdf`, pageCount: 9999999 },[{ buttonId: `${prefix}command`, buttonText: { displayText: 'ALL MENU♡' }, type: 1 }], {quoted:fvid, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} - ${pushname}\nJangan Buly Saya Stah :(`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/x-O0WHkv3uc`}}})
break

case 'menu2':
img =  fs.readFileSync('./poto/herman.jpg')
ntahlah = `Hai ${pushname} 👋${tampilUcapan}
I'M ITSUKI Bo†z ×͜×
BOT INFO
✿ _*Nama Bot : ${botname}*_
✮ _️Nama Owner : ${ownername}_
...
〔 *${botname}* 〕`
            but = [
            { buttonId: `${prefix}command`, buttonText: { displayText: 'ALL MENU👑️' }, type: 1 },
            { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER📔' }, type: 1 }
                 ]
            sendButLocation(from, ntahlah, faketeks, img, but)
            break
case 'allmenu':
simple.updatePresence(from, Presence.recording)
teks =
